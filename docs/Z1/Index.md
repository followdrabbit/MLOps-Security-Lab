...
### 2.1 Reverse Proxy / API Gateway (Ingestion Gateway) [Detalhamento](./2.1.md))
...
### 2.2 WAF (Web Application Firewall) [Detalhamento](./2.2.md)
...
### 2.3 Autenticação & Autorização (AuthN/AuthZ) na borda [Detalhamento](./2.3.md)
...
### 2.4 Content Validation (Validação de Conteúdo) [Detalhamento](./2.4.md)
...
### 2.5 Anti-malware, CDR & Sandbox [Detalhamento](./2.5.md)
...
### 2.6 Data Quality & Anomaly Checks (Higiene inicial) [Detalhamento](./2.6.md)
...
### 2.7 ETL / Streaming / MQ (Conectores Oficiais) [Detalhamento](./2.7.md)
...
### 2.8 Auditoria & Observabilidade [Detalhamento](./2.8.md)
